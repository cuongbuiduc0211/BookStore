 ...
 * @author USER
 */
@WebServlet(name = "CreateNewAccountErrServlet", urlPatterns = {"/CreateNewAccountErrServlet"})
public class CreateNewAccountErrServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Insert occurs errors</h1>");
